...
grep msgid tmp_translations/recensio.pot > tmp_translations/new.pot
grep msgid src/recensio.translations/recensio/translations/locales/recensio.pot > tmp_translations/current.pot
